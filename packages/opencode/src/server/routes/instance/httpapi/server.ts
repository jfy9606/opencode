...
import { webProviderRoute } from "./handlers/web-provider"
...
const webProviderRawRoute = webProviderRoute.pipe(
  Layer.provide(authOnlyRouterLayer),
)
...
export function createRoutes(
  ...
  return Layer.mergeAll(rootApiRoutes, eventApiRoutes, ptyConnectApiRoutes, instanceRoutes, docRoute, uiRoute, webProviderRawRoute).pipe(
    Layer.provide([
      errorLayer,
      compressionLayer,
      corsVaryFix,
